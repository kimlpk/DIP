...
# Save the image
cv2.imwrite('bodybone_original_image.png', image)
cv2.imwrite('bodybone_sobel_image.png', sobel_xy)
cv2.imwrite('bodybone_laplacian_image.png', laplacian_image)
cv2.imwrite('bodybone_final_image.png', result)
